        ...
        <div className="flex justify-center items-center min-h-[calc(100vh-350px)]">
            <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <form onSubmit={handleSubmit} className="mt-6">
                    ...
                    <div className="mt-6">
                        <button type="submit" className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#14456A] rounded-lg hover:bg-[rgba(17,136,188,.8)] focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
                            Login
                        </button>
                    </div>
                </form>
                ...
                <div className="flex items-center mt-6 -mx-2">
                    <button onClick={handleGoogleLogIn} type="button" className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-[rgb(17,136,188)] rounded-lg hover:bg-[#14456A] focus:bg-[rgba(17,136,188,.8)] focus:outline-none">
