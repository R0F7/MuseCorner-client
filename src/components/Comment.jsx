        ...
        <div className="">
            <div className="w-full max-w-md px-8 py-4 mt-10 bg-whit bg-red-400 rounded-lg shadow-lg dark:bg-gray-800">
                <div className="flex justify-center -mt-10 md:justify-end">
                    <img className="object-cover w-14 h-14 border-x-2 border-t-2 border-blue-500 rounded-full bg-white dark:border-blue-400" alt="Testimonial avatar" src={user_image} />
                </div>
